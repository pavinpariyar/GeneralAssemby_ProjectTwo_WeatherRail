    ...
    <div className="box">
      ...
      {status.map((line) => (
        <div key={line.id} className="is-flex is-justify-content-center is-align-items-center my-2">
          ...
          <span className={`tag animate__animated animate__hover animate__pulse status-hover has-text-weight-bold ${line.lineStatuses[0].statusSeverity === 10 ? 'is-success' : 'is-warning'}`}>
...
<svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="icon-bottom-right text-gray-400 text-2xl cursor-pointer is-fixed-bottom is-pulled-right" data-id="76"><polygon points="3 6 9 3 15 6 21 3 21 18 15 21 9 18 3 21"></polygon><line x1="9" x2="9" y1="3" y2="18"></line><line x1="15" x2="15" y1="6" y2="21"></line></svg>    </a>
      </div>
